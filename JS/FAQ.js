...
const Questions = [
  ...
  },
  {
    id: 4,
    title:
      'Hur många universitet måste jag söka för att vara säker på att få en plats?'
  },
  {
    id: 5,
    title:
      'Jag har bytt program, hur fungerar det med behörighet och betygssnitt?'
  },
  {
    id: 6,
  ...
  },
  {
    id: 9,
    title:
      'Vart ska jag vända mig ifall jag råka ut för en olycka eller något händer?'
  },
  {
    id: 10,
  ...
  },
  {
    id: 15,
    title:
      'Vad händer om jag blir antagen till en utbildning men jag ångrar mig?'
  }
]
...
const Answers = [
  {
    id: 0,
    title:
      'Vänd dig till den internationella kontaktpersonen vid ditt program för att få information om möjligheten att åka på utbyte inom ditt program.'
  },
  {
    id: 1,
  ...
  },
  {
    id: 2,
    title:
      'Ja, du kan ansöka om studiemedel från CSN som vanligt för din utbytestermin.'
  },
  {
    id: 3,
    title:
      'Studieplanen måste stämma överens med universitetsinformationen i SoleMove. Därefter högst betygssnitt. Om flera studenter har samma meritvärde avgörs urvalet genom en samlad bedömning av ansökan där störst vikt läggs vid motivationsbrev (Statement of Purpose) och CV.'
  },
  {
    id: 4,
    title:
  ...
  },
  {
    id: 9,
    title:
      'Vid allvarlig sjukdom, intagning på sjukhus eller behov av annan aktiv skadehjälp utanför Norden, skall omedelbar kontakt tas med Falck Global Assistance'
  },
  {
    id: 10,
    title:
      'Vissa universitet har krav på språktest. Exempelvis kan utbytesstudenter i vissa fall behöva skriva ett Test of English as a Foreign Language, TOEFL.'
  },
  {
    id: 11,
    title:
      'Det går inte att söka utbytesstudier tillsammans. Däremot kan ni ansöka till samma utbyteslärosäte men utbytesplatserna blir tilldelade utifrån ett meritvärde som räknas ut i placeringsprocessen.'
  },
  {
    id: 12,
    title:
      'Ett Learning agreement måste alla studenter fylla i innan de åker på utbytesstudier. Det är ett kontrakt mellan dig, ansvarig för tillgodoräkning och utbytesuniversitetet om din studieplan för din termin.'
  },
  {
    id: 13,
    title:
      'Många skolor erbjuder alternativ för studentboende. I vissa fall finns boende på campus, medan man i andra fall söker lägenhet i stan på egen hand. Vi informerar gärna om de olika alternativen och kommer med tips och råd inför flytten'
  },
  {
    id: 14,
    title:
      ' USA får du generellt sett inte arbeta när du är där som student. Det finns dock undantag och det går att arbeta på skolans campusområde eller på praktikplatser (internships).'
  },
  {
    id: 15,
    title:
      'Det är respektive college/universitets villkor som gäller för återbetalning och avgifter vid exempelvis avbokning och uppskjutande av studier och det är viktigt att du tar del av skolans villkor i samband med att du gör din ansökan. Vi försöker dock alltid hjälpa dig om det skulle uppstå några problem. Det är viktigt att du kontaktar oss så snart som möjligt i sådana fall.'
  }
]

//Renders questions and answers into HTML (also including advertisements)
...
//Function outlining template for creating the question HTML elements included in the FAQ
//(rendered in renderQuestions).
function createDiv (title, answer, wrapper) {
  ...
  //event listener for drop-down:s (answers to Q:s)
...
//Function outlining template for creating the answer HTML elements included in the FAQ
//(rendered in renderQuestions).
